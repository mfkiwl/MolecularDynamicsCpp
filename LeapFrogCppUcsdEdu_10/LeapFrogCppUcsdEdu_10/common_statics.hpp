...
const int Constants::SAVE_TRAJECTORY_FREQ = 1;
const int Constants::SAVE_ENERGY_FREQ = 1;
const int Constants::ADJUST_TEMP_FREQ = 1;

const real Constants::SIM_BOX_DIMENSION = 6.0; // dimension of the simulation box
...
const real Constants::TARGET_TEMPTR = 300.0 * KB; // target temperature in KB
